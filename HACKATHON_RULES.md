...
For this portfolio, do not turn Lineage Fuzzer into a shared shell or minor reskin of another entry. Its chaos-testing workflow, implementation, repository, demo, and claims must stand on their own.
...
## Lineage Fuzzer scoring checklist

- [ ] DataHub lineage determines high-value fault locations and predicted blast radius.
- [ ] At least three distinct faults execute against isolated fixtures.
- [ ] Safety controls prevent production or unmarked targets.
- [ ] Baseline detection coverage is measured objectively.
- [ ] At least one generated test artifact executes successfully.
- [ ] The same seeded campaign proves the coverage improvement.
- [ ] Fixture restoration is automatic and verified.
- [ ] Campaign results are written back to DataHub.
